...
$q7 = "select fname,lname,phone,password from regst where email='" . $n . "'";
...
if (isset($_POST['submit'])) {
  ...
  $sql = "update `regst` set password='$pass' ,fname='$fname', phone='$phone' where email='" . $n . "'";
...
if (isset($_POST['valsub'])) {
  $pnamee = $_POST['productid'];
  //echo "<script> alert('.$pnamee.');</script>";
  $_SESSION['pid'] = $pnamee;
...
<body>
  <div class="hero_area sub_pages">
    ...
    <header class="header_section" style="background-color: #798E9C;">
      <div class="container">
          ...
          <div class="modal-body">
            <form>
              <div class="form-group">
                ...
                <div style="font-weight:bold"><?php echo "$fname"; ?></div>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Last Name:</label>
                <div style="font-weight:bold"><?php echo "$lname"; ?></div>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Email:</label>
                <div style="font-weight:bold"><?php echo "$n"; ?></div>
              </div>
              <div class="form-group">
                <label for="exampleInputEmail1">Phone:</label>
                <div style="font-weight:bold"><?php echo "$phn"; ?></div>
              </div>
